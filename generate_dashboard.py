...
<!-- 특이사항 플로팅 버튼 -->
<button class="fab" onclick="openNoteModal()" title="특이사항 입력">✏️</button>
...
<div class="modal-overlay" id="noteModal">
  <div class="modal">
    <h3>✏️ 특이사항 입력</h3>
    <label>날짜</label>
    <input type="text" id="noteDate" placeholder="2026.05.15">
    <label>특이사항</label>
